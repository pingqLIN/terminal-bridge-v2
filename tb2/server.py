...
def _fleet_reconciliation_snapshot(
    *,
    ...
    orphaned_workstreams = orphaned_workstream_entries(payloads)
    stale_workstreams = stale_workstream_entries(payloads)
    return {
...
def _recovery_status_snapshot(
    ...
    *,
    ...
    return recovery_status_snapshot(
        workstream_payloads,
        continuity=continuity,
        default_protocol=workstream_recovery_protocol(),
        default_restore_order=workstream_restore_order(),
    )
...
def _fleet_governance_compliance_snapshot(workstreams: List[Dict[str, Any]]) -> Dict[str, Any]:
    return fleet_governance_compliance_snapshot(workstreams)
