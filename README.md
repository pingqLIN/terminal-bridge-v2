...
- `status.governance_compliance` now exposes read-only fleet governance compliance state, issue counts, and per-workstream issue lists; the GUI status badge highlights non-compliant states
